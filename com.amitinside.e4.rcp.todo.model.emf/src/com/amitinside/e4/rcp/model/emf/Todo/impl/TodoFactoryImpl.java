...
public class TodoFactoryImpl extends EFactoryImpl implements TodoFactory {
	...
	public static TodoFactory init() {
		try {
			final TodoFactory theTodoFactory = (TodoFactory) EPackage.Registry.INSTANCE
					.getEFactory(TodoPackage.eNS_URI);
	...
	public Todo createTodo() {
		final TodoImpl todo = new TodoImpl();
		return todo;
	}
